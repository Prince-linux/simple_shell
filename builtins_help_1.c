...
/**
 * help_all - Displays all possible builtin shellpee commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the shellpee builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the shellpee builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the shellpee builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shellpee builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible shellpee builtin commands.\n";
